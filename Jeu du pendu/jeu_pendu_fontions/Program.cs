...
namespace jeu_pendu_fontions
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            motPendu = motPendu.Replace("é", "e").Replace("è", "e");
            ...
            int tries = 5;
            Console.WriteLine("JOUEUR 2 : Devinez le mot choisit par le JOUEUR 1 en entrant un caractère à la fois");
            Console.WriteLine("Vous avez droit à " + tries + " fautes en tout");
            do
            {
                win = false;
